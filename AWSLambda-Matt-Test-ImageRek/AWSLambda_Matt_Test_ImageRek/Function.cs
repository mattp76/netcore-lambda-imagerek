...
namespace AWSLambda_Matt_Test_ImageRek
{
    public class Function
    {
        ...
        public Function()
        {
            ...
            AmazonRekognitionConfig config = new AmazonRekognitionConfig()
            {
                ...
                ServiceURL = "https://rekognition.us-west-2.amazonaws.com"
            };

            this.RekognitionClient = new AmazonRekognitionClient(config);
        ...
        public async Task FunctionHandler(S3Event input, ILambdaContext context)
        {
            ...
            foreach (var record in input.Records)
            {
                ...
                Console.WriteLine($"TEST Looking for labels in image {record.S3.Bucket.Name}:{record.S3.Object.Key}");
                ...
                catch (Exception e)
                {
                    ...
                    Console.WriteLine("RekognitionClient >>>>>>>>>>>" + RekognitionClient.Config.RegionEndpoint);
                    Console.WriteLine("S3Client >>>>>>>>>>>" + this.S3Client.Config.RegionEndpoint);
                    Console.WriteLine("RekognitionClient >>>>>>>>>>>" + RekognitionClient.Config.ServiceURL);
                    Console.WriteLine("S3Client >>>>>>>>>>>" + this.S3Client.Config.ServiceURL);
                }


                Console.WriteLine("We got here >>>>>>>>>>> {record.S3.Bucket.Name}:{record.S3.Object.Key}");
