...
using AWSLambda_Matt_Test_ImageRek;
using Amazon.Lambda.S3Events;

namespace AWSLambda_Matt_Test_ImageRek.Tests
{
    public class FunctionTest
    {
        ...
        public async Task IntegrationTest()
        {
            ...
            var bucketName = "lambda-AWSLambda_Matt_Test_ImageRek-".ToLower() + DateTime.Now.Ticks;
